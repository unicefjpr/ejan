...
import org.ei.drishti.commonregistryexample.PersonClientsProvider;
import org.ei.drishti.commonregistryexample.PersonServiceModeOption;
...
public class NativeDhakaSmartRegisterActivity extends SecuredNativeSmartRegisterActivity {
    ...
    protected DefaultOptionsProvider getDefaultOptionsProvider() {
        return new DefaultOptionsProvider() {
            ...
            public ServiceModeOption serviceMode() {
                return new DhakaServiceModeOption(clientsProvider());
            }
    ...
    protected NavBarOptionsProvider getNavBarOptionsProvider() {
        return new NavBarOptionsProvider() {
            ...
            public DialogOption[] sortingOptions() {
                return new DialogOption[]{new CommonObjectSort(false,true,false,"husband_name"),
                        new CommonObjectSort(true,false,false,"woman_name")};
            }
    ...
    protected SmartRegisterClientsProvider clientsProvider() {
        if (clientProvider == null) {
            clientProvider = new DhakaClientsProvider(
    ...
    protected void onInitialization() {
        controller = new CommonPersonObjectController(context.allCommonsRepositoryobjects("test_eligible_couple"),
                context.allBeneficiaries(), context.listCache(),
                context.personObjectClientsCache(),"woman_name","test_eligible_couple");
