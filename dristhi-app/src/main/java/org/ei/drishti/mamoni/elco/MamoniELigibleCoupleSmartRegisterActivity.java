...
public class MamoniELigibleCoupleSmartRegisterActivity extends SecuredNativeSmartRegisterActivity {
    ...
    protected DefaultOptionsProvider getDefaultOptionsProvider() {
        return new DefaultOptionsProvider() {
            ...
            public ServiceModeOption serviceMode() {
                return new MamoniModeOption(clientsProvider());
            }
    ...
    protected SmartRegisterClientsProvider clientsProvider() {
        if (clientProvider == null) {
            clientProvider = new MamoniEligibleCoupleClientsProvider(
    ...
    private DialogOption[] getEditOptions() {
        return new DialogOption[]{
                ...
                new OpenFormOption("Register Pregnant Woman", "PW", formController),
                new OpenFormOption("Register Death", "death_registration", formController),
                new OpenFormOption("Edit ELCO", "elco_registration", formController)
        };
    }
    ...
    protected void startRegistration() {
        ...
        startFormActivity("ELCO", null,fieldOverrides.getJSONString());
    }
